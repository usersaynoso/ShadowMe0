...
CREATE TYPE "public"."event_type_enum" AS ENUM('friendship_accepted', 'message_sent', 'shadow_session_created', 'post_created', 'post_liked', 'post_commented');--> statement-breakpoint
